// src/components/layout/Sidebar.tsx (Full Rebuilt Code)
import React from 'react';
import { NavLink } from 'react-router-dom';

// Placeholder Icons - Use your actual SVG icon components
            ...
            <nav className="flex-1 p-4 space-y-1">
                {navigationItems.map(item => (
                    <NavLink
                        key={item.name}
                        to={item.to}
                        end // Use 'end' for the root route to prevent it matching all routes
